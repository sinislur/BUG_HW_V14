...
🌷 KALAU MAU RENAME TARO CREDITS GUA : Yanz Mods BUG */
...
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid } = require('./base/lib/exif')
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, fetchJson, await, sleep } = require('./base/lib/myfunc')
//=================================================//
...
low = require('./base/lib/lowdb')}
//=================================================//
const { Low, JSONFile } = low
const mongoDB = require('./base/lib/mongoDB')
//=================================================//
//=================================================//
...
new mongoDB(opts['db']) :
new JSONFile(`base/dbnye/database.json`)
)
...
require("./diablo")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)}})
//=================================================//
...
let { writeExif } = require('./base/lib/exif')
...
if (options.asDocument) type = 'document'
if (options.asSticker || /webp/.test(mime)) {
let { writeExif } = require('./base/lib/sticker.js')
let media = { mimetype: mime, data }
...
ext: '.bin'}
filename = path.join(__filename, '../base/dbnye/' + new Date * 1 + '.' + type.ext)
